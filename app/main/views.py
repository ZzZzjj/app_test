...
def index():
	...
	pagination = Post.query.order_by(Post.timestamp.desc()).paginate(
		page, 
		error_out=False)   #  per_page=current_app.config['FLASKY_POSTS_PER_PAGE'],
...
def edit_profile_admin(id):
	...
	if form.validate_on_submit():
		...
		return redirect(url_for('.user', username=uaer.username))
...
def followers(username):
	...
	pagination = user.followers.paginate(
		page, 
		error_out=False)  # per_page=current_app.config['FLASKY_FOLLOWERS_PER_PAGE'],
